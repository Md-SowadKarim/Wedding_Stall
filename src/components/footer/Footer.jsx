    ...
    return (
        <div className="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 py-12">
            <div className="flex flex-col items-center justify-center">
                <div className='bold'>
                    <h1 className="font-extrabold text-3xl">Wedding_Stall</h1>
                    <hr data-aos="fade-left" className='h-1 bg-blue-500 w-[35%] my-2'/>
                </div>
                <div className="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8">
                    <p className="hover:text-gray-500 text-base cursor-pointer leading-4 text-white"><a href='/about'>About</a></p>
                    <p className="hover:text-gray-500 text-base cursor-pointer leading-4 text-white"> <a href='/contact'>Contact us</a>  </p>
                    <p className="hover:text-gray-500 text-base cursor-pointer leading-4 text-white"><a  href={user? "/feature":"/signup"}>Register</a></p>
                ...
                <div className="flex items-center mt-6">
                    <p className="text-base leading-4 text-white">
                        2023 <span className="font-semibold">Wedding_stall</span>
                    </p>
                    <div className="border-l text-white pl-2 ml-2">
